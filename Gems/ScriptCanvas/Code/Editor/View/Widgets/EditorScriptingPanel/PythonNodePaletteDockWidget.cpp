...
#include "PythonNodePaletteDockWidget.h"
...
namespace ScriptCanvasEditor
{
    namespace Widget
    {
        ...
        GraphCanvas::NodePaletteTreeItem* PythonNodePaletteWidget::ExternalCreateNodePaletteRoot(const PythonNodePaletteModel& nodePaletteModel, AzToolsFramework::AssetBrowser::AssetBrowserFilterModel* assetModel)
        {
            PythonScriptCanvasRootPaletteTreeItem* root = aznew PythonScriptCanvasRootPaletteTreeItem(nodePaletteModel, assetModel);
        ...
        PythonScriptCanvasNodePaletteConfig::PythonScriptCanvasNodePaletteConfig(const PythonNodePaletteModel& nodePaletteModel, AzToolsFramework::AssetBrowser::AssetBrowserFilterModel* assetModel, bool isInContextMenu)
            : m_nodePaletteModel(nodePaletteModel)
            , m_assetModel(assetModel)
        {
            ...
            m_rootTreeItem = Widget::PythonNodePaletteWidget::ExternalCreateNodePaletteRoot(nodePaletteModel, assetModel);
        }

        PythonScriptCanvasNodePaletteConfig::~PythonScriptCanvasNodePaletteConfig()
        {
        ...
        PythonNodePaletteDockWidget::PythonNodePaletteDockWidget(const QString& windowLabel, QWidget* parent, const PythonScriptCanvasNodePaletteConfig& paletteConfig)
            ...
            , m_ignoreSelectionChanged(false)
        {
            ...
            if (!paletteConfig.m_isInContextMenu)
            {
                 ...
                 //AddSearchCustomizationWidget(this);
...

                {
                    ...
                    QObject::connect(m_nextCycleAction, &QAction::triggered, this, &PythonNodePaletteDockWidget::CycleToNextNode);
                }

                {
                    ...
                    QObject::connect(m_previousCycleAction, &QAction::triggered, this, &PythonNodePaletteDockWidget::CycleToPreviousNode);
                }

                QObject::connect(treeView->selectionModel(), &QItemSelectionModel::selectionChanged, this, &PythonNodePaletteDockWidget::OnTreeSelectionChanged);
                QObject::connect(treeView, &GraphCanvas::NodePaletteTreeView::OnTreeItemDoubleClicked, this, &PythonNodePaletteDockWidget::HandleTreeItemDoubleClicked);

                {
                    ...
                    QObject::connect(m_openTranslationData, &QAction::triggered, this, &PythonNodePaletteDockWidget::OpenTranslationData);
                }

                {
                    ...
                    QObject::connect(m_generateTranslation, &QAction::triggered, this, &PythonNodePaletteDockWidget::GenerateTranslation);
                }
        ...
        PythonNodePaletteDockWidget::~PythonNodePaletteDockWidget()
        {
            GraphCanvas::AssetEditorNotificationBus::Handler::BusDisconnect();
            GraphCanvas::SceneNotificationBus::Handler::BusDisconnect();
        }

        void PythonNodePaletteDockWidget::OnActiveGraphChanged(const GraphCanvas::GraphId& graphCanvasGraphId)
        {
            GraphCanvas::SceneNotificationBus::Handler::BusDisconnect();
        ...
        void PythonNodePaletteDockWidget::OnSelectionChanged()
        {
        ...
        GraphCanvas::GraphCanvasTreeItem* PythonNodePaletteDockWidget::CreatePaletteRoot() const
        {
            PythonScriptCanvasRootPaletteTreeItem* root = aznew PythonScriptCanvasRootPaletteTreeItem(m_nodePaletteModel, m_assetModel);

            const NodePaletteModel::NodePaletteRegistry& nodeRegistry = m_nodePaletteModel.GetNodeRegistry();
        ...
        void PythonNodePaletteDockWidget::OnTreeSelectionChanged(const QItemSelection&, const QItemSelection&)
        {
            ClearCycleTarget();
        ...
        void PythonNodePaletteDockWidget::AddCycleTarget(ScriptCanvas::NodeTypeIdentifier cyclingIdentifier)
        {
        ...
        void PythonNodePaletteDockWidget::ClearCycleTarget()
        {
        ...
        void PythonNodePaletteDockWidget::CycleToNextNode()
        {
            ConfigureHelper();
        ...
        void PythonNodePaletteDockWidget::CycleToPreviousNode()
        {
            ConfigureHelper();
        ...
        void PythonNodePaletteDockWidget::HandleTreeItemDoubleClicked(GraphCanvas::GraphCanvasTreeItem* treeItem)
        {
            ParseCycleTargets(treeItem);
            CycleToNextNode();
        }

        void PythonNodePaletteDockWidget::NavigateToTranslationFile(GraphCanvas::NodePaletteTreeItem* nodePaletteItem)
        {
            if (nodePaletteItem)
            {
        ...
        void PythonNodePaletteDockWidget::GenerateTranslation()
        {
            QModelIndexList indexList = GetTreeView()->selectionModel()->selectedRows();
        ...
        void PythonNodePaletteDockWidget::OpenTranslationData()
        {
            QModelIndexList indexList = GetTreeView()->selectionModel()->selectedRows();
        ...
        void PythonNodePaletteDockWidget::ConfigureHelper()
        {
        ...
        void PythonNodePaletteDockWidget::ParseCycleTargets(GraphCanvas::GraphCanvasTreeItem* treeItem)
        {
        ...
        PythonScriptCanvasRootPaletteTreeItem::PythonScriptCanvasRootPaletteTreeItem(const PythonNodePaletteModel& nodePaletteModel, AzToolsFramework::AssetBrowser::AssetBrowserFilterModel* assetModel)
            : ScriptCanvasRootPaletteTreeItem(nodePaletteModel, assetModel)
            , m_nodePaletteModel(nodePaletteModel)
            //, m_assetModel(assetModel)
        {}
    }
...
#include <Editor/View/Widgets/EditorScriptingPanel/moc_PythonNodePaletteDockWidget.cpp>
